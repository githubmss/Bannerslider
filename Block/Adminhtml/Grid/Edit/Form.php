<?php
namespace Mmsbuilder\Bannersliderapp\Block\Adminhtml\Grid\Edit;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    public function __construct(
        ...
        \Mmsbuilder\Bannersliderapp\Model\Status $options,
        array $data = []
    ) {
        ...
        if ($this->getRequest()->getParam('id')) {
            $fieldset->addField(
                ...
                [
                    ...
                    'index'    => 'image',
                    'renderer' => '\Mmsbuilder\Bannersliderapp\Block\Adminhtml\Bannersliderapp\Grid\Renderer\LogoImage',
            ...
            )->setAfterElementHtml("<script type=\"text/javascript\">var d = document.getElementById(\"mssslider_thumbnail\");d.className += \" required-entry\";</script>");
        }
